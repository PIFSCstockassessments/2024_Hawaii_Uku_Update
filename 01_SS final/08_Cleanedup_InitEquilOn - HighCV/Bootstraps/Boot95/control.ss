...
#_    LO   HI    INIT   PRIOR   PR_SD    PR_type   PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn #  parm_name
    1   10       4.314   4.314   99    0    1    0    0    0    0    0    0    0 # SR_LN(R0)
...
#_    LO   HI    INIT PRIOR PR_SD PR_type PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
     -10   -1     -5    0    1    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_old(1)
     -10   -1    -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_recent(2)
     -10   -1     -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_ISH_recent(3)
     -15   -1    -10   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_Trol_recent(4)
     -15   -1     -9   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_OPUE_Divers(7)    
#
#_size_selex_types
...
#
#_  LO   HI    INIT   PRIOR   PR_SD    PR_type   PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
    10  100    53.4    53.4   99    0     2    0    0    0    0    0    0    0  #  SizeSel_P1_Com_Deep(1)
    5   60    20.4    20.4   99    0     3    0    0    0    0    0    0    0  #  SizeSel_P2_Com_Deep(1)
