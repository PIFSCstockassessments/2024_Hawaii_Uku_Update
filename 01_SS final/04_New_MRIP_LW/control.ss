...
#_    LO   HI    INIT PRIOR PR_SD PR_type PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
     -10   0     -5    0    1    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_old(6)
     -15   0     -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_recent(7)
     -10   0     -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_ISH_recent(8)
     -15   0     -11   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_Trol_recent(9)
     -15   0     -10   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_OPUE_Divers(10)    
#
#_size_selex_types
...
#_  LO   HI    INIT   PRIOR   PR_SD    PR_type   PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
    ...
    5   90    36.3    36.3   99    0    -2    0    0    0    0    0    0    0  #  SizeSel_P1_Rec(5)
    5   90    14.4    14.4   99    0    -3    0    0    0    0    0    0    0  #  SizeSel_P2_Rec(5)
