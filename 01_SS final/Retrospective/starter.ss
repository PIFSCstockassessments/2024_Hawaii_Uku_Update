...
2023 # max yr for sdreport outputs (-1 for endyr; -2 for endyr+Nforecastyrs
0 # N individual STD years 
#vector of year values 
0.0001 # final convergence criteria (e.g. 1.0e-04) 
0 # retrospective year relative to end year (e.g. -4)
1 # min age for calc of summary biomass
2 # Depletion basis:  denom is: 0=skip; 1=rel X*B0; 2=rel SPBmsy; 3=rel X*B_styr
...
5 30 #_min and max age over which average F will be calculated
