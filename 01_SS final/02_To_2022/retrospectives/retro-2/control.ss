...
#_    LO   HI    INIT   PRIOR   PR_SD    PR_type   PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn #  parm_name
    1   25          4       4   99    0    1    0    0    0    0    0    0    0 # SR_LN(R0)
...
1940.0 #_last_early_yr_nobias_adj_in_MPD
1964.4 #_first_yr_fullbias_adj_in_MPD
1989.6 #_last_yr_fullbias_adj_in_MPD
2017.9 #_first_recent_yr_nobias_adj_in_MPD
0.4408 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_  LO  HI INIT  PRIOR PR_SD  PR_type  PHASE
 0.001   5 0.05 0.1 99  0   1 # InitF_seas_1_flt_Com
#
#_Q_setup
...
#_    LO   HI    INIT PRIOR PR_SD PR_type PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
     -20   20     -5    0    1    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_old(6)
     -20   20     -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_DSH_recent(7)
     -20   20     -7    0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_ISH_recent(8)
     -20   20     -11   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_CPUE_Trol_recent(9)
     -20   20     -10   0    2    0   1    0    0    0    0    0    0    0  #  LnQ_base_OPUE_Divers(10)    
#
#_size_selex_types
#_Pattern Discard Male Special
  1    0 0 0  # 1 Com_Deep
  1    0 0 0  # 2 Com_Inshore
  1    0 0 0  # 3 Com_Trolling
  1    0 0 0  # 4 Com_Other
  1    0 0 0  # 5 Rec catch
...
#_age_selex_types
#_Pattern Discard Male Special
  0    0 0    0 # 1 Com_Deep catch
  0    0 0    0 # 2 Com_Inshore catch
  0    0 0    0 # 3 Com_Trolling catch
  0    0 0    0 # 4 Com_Other catch
  0    0 0    0 # 5 Rec catch
...
#
#_  LO   HI    INIT   PRIOR   PR_SD    PR_type   PHASE env-var use_dev   dev_mnyr   dev_mxyr  dev_PH   Block Blk_Fxn  #  parm_name
    5   110   51.6    51.6   99    0     2    0    0    0    0    0    0    0  #  SizeSel_P1_Com_Deep(1)
    5   120   16.5    16.5   99    0     3    0    0    0    0    0    0    0  #  SizeSel_P2_Com_Deep(1)
    5   90    36.4    36.4   99    0    -2    0    0    0    0    0    0    0  #  SizeSel_P1_Com_Inshore(2)
    5   90    11.4    11.4   99    0    -3    0    0    0    0    0    0    0  #  SizeSel_P2_Com_Inshore(2)
    5   90    45.9    45.9   99    0    -2    0    0    0    0    0    0    0  #  SizeSel_P1_Com_Trolling(3)
    5   90    15.7    15.7   99    0    -3    0    0    0    0    0    0    0  #  SizeSel_P2_Com_Trolling(3)
    5   90    48.9    48.9   99    0    -2    0    0    0    0    0    0    0  #  SizeSel_P1_Com_Other(4)
    5   90    13.3    13.3   99    0    -3    0    0    0    0    0    0    0  #  SizeSel_P2_Com_Other(4)
    5   90    35.0    35.0   99    0    -2    0    0    0    0    0    0    0  #  SizeSel_P1_Rec(5)
    5   90    15.0    15.0   99    0    -3    0    0    0    0    0    0    0  #  SizeSel_P2_Rec(5)
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P1
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P2
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P1
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P2
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P1
   -1   -1      -1      -1   99    0    -4    0    0    0    0    0    0    0  #  SizeSel_P2
